function [plugin, delta, corrected, decomp_pi, decomp_b, dim_fe, NT] = correction(y, id, firmid, other_fe, mat_controls, n_lev, n_boot,...
    ...
    % "correction_match.m".
    % For corrections for different groups of the sample use "correction_groups.m"
    ...
    % Run bootstrap
    tic
    [delta, corrected] = bootstrap(n_boot, B_plus_par.Value, B_minus_par.Value,...
