function [plugin, delta, corrected, decomp_pi, decomp_b, dim_fe, NT] = correction_cluster_multi_group(y, id, firmid, cluster, group, other_fe, mat_controls, n_lev,...    
    ...
    % Run bootstrap
    tic
    delta = bootstrap_cluster_multi_group(n_boot, B_plus_par.Value, B_minus_par.Value,...
