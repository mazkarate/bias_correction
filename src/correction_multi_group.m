function [plugin, delta, corrected, decomp_pi, decomp_b, dim_fe, NT] = correction_multi_group(y, id, firmid, group, other_fe, mat_controls, n_lev, n_boot,...
                                                                                                type_hc, type_leave, ind_light, mytol, ind_export, filename, v_filename_group)
    %%%% CORRECTION FOR DIFFERENT GROUPS WITH SEVERAL GROUPING IDENTIFIERS %%%%%
    % Description: This code does the bias corrections on the entire sample and
    % different subsamples as determined by the group matrix.
    ...
    clear u_group_old i_old_group_aux
